...
namespace SteamworksPlus.Runtime.ScriptableObjects
{
    /// <summary>
	...
	public class SPLobbySettings : ScriptableObject
	{
        /// <summary>
        ...
        /// </summary>
        [MinValue(1), Tooltip("Maximum number of players that can be added to the lobby")]
